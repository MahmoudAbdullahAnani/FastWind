                    ...
                    <div className="relative p-4">
                        <div className="pointer-events-auto w-[100%] max-w-[400px] rounded-lg bg-white text-[0.8125rem]/5 text-slate-700 shadow-xl shadow-black/5 ring-1 ring-slate-700/10">
                            <div className="flex items-center px-3.5 py-2.5 text-slate-400">
                                <svg className="mr-2 size-5 stroke-slate-500" fill="none" viewBox="0 0 24 24" strokeWidth="2"><path strokeLinecap="round" strokeLinejoin="round" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"></path></svg><input className="w-full h-full focus-visible:border-none focus:border-none border-none text-black rounded-lg" type="text" placeholder="Search projects..." />
                            </div>
                            <div className="border-t border-slate-400/20 px-3.5 py-3">
                                ...
                                <div className="group flex items-center rounded-md p-1.5 cursor-pointer hover:bg-indigo-600 hover:text-white">
                            ...
                            <div className="border-t border-slate-400/20 px-3.5 py-3">
                                <div className="group hover:bg-indigo-600 cursor-pointer hover:text-white flex items-center rounded-md p-1.5">
