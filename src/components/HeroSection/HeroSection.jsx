        ...
        <Container classNames={"px-0 dark:bg-black"}>
            <main className="relative flex flex-nowrap items-start justify-between py-8 lg:col-span-7 lg:py-12 xl:col-span-6 overflow-hidden">
                ...
                <div className="max-w-[722px] relative md:block hidden opacity-0 animate-slideIn"
                    style={{
                        animationDelay: '0.5s',
                        transform: 'translateY(var(--scroll-offset, 0px)) rotate(-12deg) skewY(-12deg)'
                    }}
                    id="floating-window">
            ...
            <style jsx>{`
                ...
                @keyframes slideIn {
                    from { opacity: 0; transform: translateX(100px) rotate(-12deg) skewY(-12deg); }
                    to { opacity: 1; transform: translateX(0) rotate(-12deg) skewY(-12deg); }
                }
                ...
                __html: `
                    document.addEventListener('DOMContentLoaded', function() {
                        ...
                        window.addEventListener('scroll', () => {
                            ...
                            const currentOffset = parseFloat(getComputedStyle(floatingWindow)
                                .getPropertyValue('--scroll-offset') || '0');
                            
                            const newOffset = Math.max(-50, Math.min(50, currentOffset - scrollDiff * 0.1));
                            
                            floatingWindow.style.setProperty('--scroll-offset', newOffset + 'px');
...
{/* <main className={` reltive flex flex-nowrap items-start justify-between px-4 py-8 lg:col-span-7 lg:py-12 xl:col-span-6 overflow-hidden`}>
                <div className={`w-[80%] mt-[80px]`}>
                    <h1 className="flex flex-nowrap gap-2 text-4xl font-bold text-gray-900 sm:text-5xl md:text-6xl">
            ...
            <div className={`relative before:content-[''] before:absolute before:top-0 before:left-0 before:text-blue-500 after:content-[''] after:absolute after:top-0 after:left-0  after:text-red-500 ` + 'md:block hidden bg-slate-500 border-2 rounded-lg py-4 w-[1024px] bottom-[20%] [transform:rotateX(-54deg)_rotateZ(-11deg)_skewY(-15deg)]'}>
